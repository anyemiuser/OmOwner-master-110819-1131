...
public class RoomTypeAndPrice {
    ...
    public RoomTypeAndPrice(String room_type, String min_price, String avg_price, String max_price, String min_status, String avg_status, String max_status, String discount) {
    ...
    public RoomTypeAndPrice(String room_type) {
        this.room_type = room_type;
    }
