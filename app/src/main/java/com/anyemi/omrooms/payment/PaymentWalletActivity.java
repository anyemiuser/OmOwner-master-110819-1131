...
// finally change the color
    ...
    private void initView2() {
        ...
        ll_paytm = (LinearLayout) findViewById(R.id.ll_paytm);
        ll_free_charge = (LinearLayout) findViewById(R.id.ll_free_charge);
        ll_phone_pe = (LinearLayout) findViewById(R.id.ll_phone_pe);
        ll_airtel_money = (LinearLayout) findViewById(R.id.ll_airtel_money);
        ll_jio_money = (LinearLayout) findViewById(R.id.ll_jio_money);
        ll_m_pesa = (LinearLayout) findViewById(R.id.ll_m_pesa);
