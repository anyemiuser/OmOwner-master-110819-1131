...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.HotelAreaViewHolder> {
    private List<HotelArea> hotelAreas;
    private Context context;

    public SearchListAdapter(List<HotelArea> hotelAreas, SearchActivity searchActivity) {
